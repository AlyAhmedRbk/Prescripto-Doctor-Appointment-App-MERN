        ...
        <div className="flex items-center gap-4">
            {
                ...
                ?<div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute right-0 top-0 pt-14 text-base font-medium text-gray-600 z-20 hidden
                    group-hover:block'>
            ...
            <img
             src={assets.menu_icon} className='w-6 md:hidden'
             ...
             <div className={`${showMenu ? 'fixed w-full' : "h-0 w-0"} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-start gap-2 mt-5 px-5 text-lg font-medium'>
                    <NavLink to={"/"} onClick={()=>setShowMenu(false)}>
                        <p className="px-4 py-2 rounded w-full inline-block">
                            HOME
                        </p>
                    </NavLink>
