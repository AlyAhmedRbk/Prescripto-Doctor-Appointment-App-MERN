  ...
  return profileData && (
    <div>
        ...
        <div className='flex flex-col gap-4 m-5'>
          <div>
            <img src={profileData.image} className='bg-primary/80 w-full sm:max-w-64 rounded-lg'/>
          </div>
          ...
          <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'> 
            ...
            {
              isEdit
              ?<button className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary
              hover:text-white transition-all duration-300' onClick={()=>{
                setIsEdit(false)
                updateProfile()
                }}>
                Save
              ...
              :<button className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary
              hover:text-white transition-all duration-300' onClick={()=>setIsEdit(true)}>
                Edit
              </button>
            }     
          </div>
